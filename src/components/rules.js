  ...
  return (
    <Box>
      ...
      <Box>
        <ul>
          <li>
            You will build an ERC1155 token with a front-end. Here are the
            requirements:
          </li>
          <li>
            You must have a total of 7 tokens withn the collection id [0-6]
          </li>
          <li>There is no supply limit for each toke</li>
          <li>
            Anyone can mint tokens [0-2], but there is a 1minute cooldown
            between mints. These are free to mint except for the gas cost.
          </li>
          <li>Token 3 can be minted by burning token 0 and .</li>
          <li>Token 4 can be minted by burning token and 2</li>
          <li>Token 5 can be minted by burning 0 and </li>
          <li>Token 6 can be minted by burning 0, 1, and </li>
